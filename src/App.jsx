...
function Modal({ open, onClose, children }) {
 ...
 <button
   ...
   className="inline-flex h-12 w-12 items-center justify-center
              rounded-full border border-white/20 bg-black/60
              text-white text-3xl leading-none
              shadow-lg hover:bg-black/70
...
<iframe
  ...
  src="https://www.youtube.com/embed/JWkB0loxNEo?rel=0&modestbranding=1&controls=1"
  title="Showreel"
